...
void callback(char *topic, byte *payload, unsigned int length)
{
  ...
  if (strcmp(topic, in_topic4) == 0)
  {                              // request to activate override mode
  ...
  if (strcmp(topic, in_topic1) == 0)
  { // call to configure per port current
  ...
  if (strcmp(topic, in_topic2) == 0)
  { // request to change port state
  ...
  if (strcmp(topic, in_topic3) == 0)
  { // request to change LED brightness
    String value = String((char *)payload);
 ...
 PIXELS_brightness();
  ...
  if (strcmp(topic, in_topic5) == 0)
  { // call to set regular rgbw color
  ...
  if (strcmp(topic, in_topic6) == 0)
  { // call to set RGB color with flash enabled
