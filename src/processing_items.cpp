...
{ // Change placeholders on webpage
  ...
  if (var == "IDssid")
  { // filling in the config page with ssid if configured
    String ssing = "";
    if (strcmp(ssid, "0") == 0)
    {
      ssing += "ssid";
  ...
  if (var == "whatpass")
  { // filling in the config page with ssid password
    String whatping = "";
  ...
  if (var == "passwhat")
  { // filling in the config page ap password
    String whatsping = "";
  ...
  if (var == "apss")
  { // filling in the config page ap ssid
    String apssing = "";
    apssing += "AP SSID = ";
    apssing += AP_SSID;
    return apssing;
  ...
  if (var == "aphid")
  { // filling in the config page ap hidden value
    String aphing = "";
    aphing += "AP hidden = ";
    aphing += AP_HIDDEN;
    return aphing;
